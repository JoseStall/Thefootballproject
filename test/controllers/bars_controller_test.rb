...
class BarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post bars_url, params: { bar: { capacity: @bar.capacity, description: @bar.description, interested_people: @bar.interested_people, name: @bar.name, pint_price: @bar.pint_price } }
    end
  ...
  test "should update bar" do
    patch bar_url(@bar), params: { bar: { capacity: @bar.capacity, description: @bar.description, interested_people: @bar.interested_people, name: @bar.name, pint_price: @bar.pint_price } }
