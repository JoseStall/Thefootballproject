...
Bar.create(name: 'La Belleviloise', description: "Comme à chaque grosse compétition footballistique, le célèbre bar du XXe arrondissement de Paris fait les choses en grand : écran géant, son stéréo et happy hour sur la bière pendant toutes les premières mi-temps, histoire d'apprécier la victoire avec encore plus d'enthousiasme. Pour ce qui est de l'en-cas, on vous conseille d'opter pour une kémia, des falafels ou un ceviche de saumon.", capacity: 100 ,pint_price: 5 ,user_id:3,address:"19-21 rue Boyer Paris", screen:"Ecran géant")
